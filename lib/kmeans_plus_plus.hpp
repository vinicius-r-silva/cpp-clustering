...
private:
  ...
  std::vector<datapoint> get_initial_centroids(const std::vector<datapoint> &data, int k);
  std::vector<std::vector<datapoint>> get_multiple_initial_centroids(const std::vector<datapoint> &data, const int k);
